...
const coaches: Coach[] = [
  ...
  },
  {
    ...
    bio: 'Иван — боец с огромным соревновательным опытом в грэпплинге, ММА, панкратионе и боевом самбо. Готовит спортсменов к турнирам любого уровня, уделяя особое внимание борцовской технике и работе в партере.',
    achievements: [
      'Чемпион Московской области по грэпплингу UWW 2024 (золото в ги и но-ги)',
      'Двукратный призёр Кубка СНГ по боевому самбо',
      'Победитель открытого кубка Москвы по панкратиону',
      'Призёр чемпионата России по BJJ и грэпплингу (ACBJJ)',
      'Призёр чемпионата мира по грэпплингу (мастерс)',
    ],
    experience: 'Более 20 лет в единоборствах, богатый соревновательный опыт',
  ...
  {
    name: 'Повидаш Виталий Евгеньевич',
    title: 'Мастер спорта по боевому самбо',
    disciplines: ['Детское самбо'],
    bio: 'Виталий — действующий профессиональный боец смешанных единоборств и мастер спорта по боевому самбо. Ведёт детское самбо, прививая юным спортсменам технику, дисциплину и любовь к борьбе.',
    achievements: [
      'Мастер спорта России по боевому самбо',
      'Чемпион всероссийского турнира по боевому самбо',
      'Призёр всероссийского турнира по рукопашному бою',
      'Чемпион Республики Коми по самбо и боевому самбо',
      'Призёр Московского турнира по грэпплингу',
      'Чемпион Кубка Арктики по боевому самбо',
      'Действующий профессиональный боец ММА',
    ],
    experience: 'Опыт преподавания 6 лет',
    image: '/images/coach-povidash.png',
  },
]
