...
const directions = [
  {
    icon: Train,
    title: 'От метро ВДНХ',
    desc: 'Выход из метро к улице Бориса Галушкина. Далее пешком или на автобусе №93, №172 до остановки «Улица Малыгина».',
  },
  {
    icon: Train,
    title: 'От метро Алексеевская',
    desc: 'Троллейбус №9, №13 или автобус №85 до остановки «Улица Малыгина».',
  },
  {
    icon: Car,
    title: 'На автомобиле',
